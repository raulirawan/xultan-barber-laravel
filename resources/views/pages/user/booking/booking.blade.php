        ...
        <div class="panel-body">
                    ...
                    <div class="form-group mb-2">
                        <div class="form-group">
                                <select name = "barber" class="form-control" required>
                                    ...
                                    <option value="JOHN">JOHN (SUDAH VAKSIN)</option>
                                    <option value="ROGER">ROGER (SUDAH VAKSIN)</option>
            ...
            <div class="row">
               ...
               echo '
                ...
                echo        '<form action=" '. route('dashboard-booking-store') .' " method="POST" enctype="multipart/form-data" class="form-horizontal form-material">
                    '. csrf_field() .' 
                    <div class="form-group">
                        <label for="example-email" class="col-md-12">Date & Time</label>
                        <div class="col-md-12">
                            <input type="date" id="date" name="date" class="form-control form-control-line" required> </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-12">Jam Booking</label>
                        <div class="col-md-12">
                            <input type="text" placeholder="Masukan Jam Booking" name="start" class="form-control form-control-line"> 
                            <div class="text-muted" style="margin-top: 10px">Contoh: booking jam 10, input angka 10</div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-12">Tukang Cukur</label>
                        <div class="col-md-12">
                            <select name="barber" id="barber" class="form-control form-control-line" required>
                                <option value="">-- Pilih Kang Cukur --</option>
                                <option value="JOHN">JOHN (SUDAH VAKSIN)</option>
                                <option value="ROGER">ROGER (SUDAH VAKSIN)</option>     
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <select name="services_id" id="services_id" class="form-control form-control-line" required>
